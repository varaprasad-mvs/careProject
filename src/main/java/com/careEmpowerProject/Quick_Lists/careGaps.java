...
public class careGaps {
	...
	public careGaps(WebDriver driver) {
		
		this.driver=driver;
		
		//this.title=this.driver.findElement(By.id(""));
		this.selectAll=this.driver.findElement(By.xpath("html/body/div[1]/div/div[2]/div/div/div[2]/div/div/div[2]/div/div[2]/div/div/div/div/div[4]/div/div/div[1]/div/div[3]"));//change the property if its not working
	}
